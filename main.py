...
def main():
    ...
    label_szczegoly_imie.grid(row=1, column=0)
    ...
    label_szczegoly_nazwisko.grid(row=1, column=4)
    label_szczegoly_nazwisko_wartosc = Label(ramka_szczegoly_obiektu, text="... ", width=10)
    label_szczegoly_nazwisko_wartosc.grid(row=1, column=5)
    ...
    map_widget=tkintermapview.TkinterMapView(ramka_szczegoly_obiektu, width=600, height=200)
    map_widget.set_position(52.0, deg_y=21)
